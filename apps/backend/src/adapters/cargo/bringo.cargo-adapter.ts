...
const BRINGO_CONFIG = {
  loggerName: 'BringoCargoAdapter',
  defaultBase: 'https://api.bringo.com.tr/v1',
...
export class BringoCargoAdapter extends RestApiKeyCargoAdapter implements ICargoAdapter {
  constructor(creds: Record<string, unknown>) {
    super(creds, BRINGO_CONFIG);
  }
}
