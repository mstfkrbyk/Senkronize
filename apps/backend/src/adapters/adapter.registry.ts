...
import { AliexpressRuAdapter } from './aliexpress-ru/aliexpress-ru.adapter';
import { AutodsAdapter } from './autods/autods.adapter';
import { AutotraderAdapter } from './autotrader/autotrader.adapter';
import { AvitoAdapter } from './avito/avito.adapter';
...
import { AvansasAdapter } from './avansas/avansas.adapter';
import { ArbuzKzAdapter } from './arbuz-kz/arbuz-kz.adapter';
...
import { BebekComAdapter } from './bebek-com/bebek-com.adapter';
...
import { CashiAdapter } from './cashi/cashi.adapter';
...
import { CarrefourSaAdapter } from './carrefour-sa/carrefour-sa.adapter';
...
import { ChaldalAdapter } from './chaldal/chaldal.adapter';
...
import { CraftsvillaAdapter } from './craftsvilla/craftsvilla.adapter';
...
import { DarazPkAdapter } from './daraz-pk/daraz-pk.adapter';
...
import { FinnNoAdapter } from './finn-no/finn-no.adapter';
...
import { FaviAdapter } from './favi/favi.adapter';
import { FloAdapter } from './flo/flo.adapter';
import { FuudyAdapter } from './fuudy/fuudy.adapter';
import { FyndiqAdapter } from './fyndiq/fyndiq.adapter';
...
import { GotoLkAdapter } from './goto-lk/goto-lk.adapter';
import { GmarketAdapter } from './gmarket/gmarket.adapter';
import { GrabMartAdapter } from './grab-mart/grab-mart.adapter';
import { GrabmartAdapter } from './grabmart/grabmart.adapter';
import { GofoodAdapter } from './gofood/gofood.adapter';
...
import { JumiaEtAdapter } from './jumia-et/jumia-et.adapter';
import { JumiaGhAdapter } from './jumia-gh/jumia-gh.adapter';
import { JumiaTnAdapter } from './jumia-tn/jumia-tn.adapter';
import { JuspayAdapter } from './juspay/juspay.adapter';
import { KadinClubAdapter } from './kadin-club/kadin-club.adapter';
import { LamodaAdapter } from './lamoda/lamoda.adapter';
import { LeroyMerlinAdapter } from './leroy-merlin/leroy-merlin.adapter';
import { LuluOnlineAdapter } from './lulu-online/lulu-online.adapter';
...
import { KupujemProdajemAdapter } from './kupujem-prodajem/kupujem-prodajem.adapter';
import { KilimallAdapter } from './kilimall/kilimall.adapter';
import { KhaadiAdapter } from './khaadi/khaadi.adapter';
import { KinguinAdapter } from './kinguin/kinguin.adapter';
import { KitapyurduAdapter } from './kitapyurdu/kitapyurdu.adapter';
import { KuklaAdapter } from './kukla/kukla.adapter';
...
import { MarketKzAdapter } from './market-kz/market-kz.adapter';
...
import { MegatradeAdapter } from './megatrade/megatrade.adapter';
...
import { NykaaAdapter } from './nykaa/nykaa.adapter';
...
import { NjuskaloAdapter } from './njuskalo/njuskalo.adapter';
...
import { OlxPtAdapter } from './olx-pt/olx-pt.adapter';
...
import { OlxPlAdapter } from './olx-pl/olx-pl.adapter';
...
import { PandamartAdapter } from './pandamart/pandamart.adapter';
import { Pazar365Adapter } from './pazar365/pazar365.adapter';
import { PazaruvajAdapter } from './pazaruvaj/pazaruvaj.adapter';
import { PowerDkAdapter } from './power-dk/power-dk.adapter';
import { PerigoldAdapter } from './perigold/perigold.adapter';
import { PepperfryAdapter } from './pepperfry/pepperfry.adapter';
...
import { PricespyAdapter } from './pricespy/pricespy.adapter';
import { RicardoChAdapter } from './ricardo-ch/ricardo-ch.adapter';
...
import { RazorpayStoreAdapter } from './razorpay-store/razorpay-store.adapter';
import { RealdeAdapter } from './realde/realde.adapter';
import { ReverbAdapter } from './reverb/reverb.adapter';
import { RelianceDigitalAdapter } from './reliance-digital/reliance-digital.adapter';
...
import { SbermarketAdapter } from './sbermarket/sbermarket.adapter';
...
import { ShohozAdapter } from './shohoz/shohoz.adapter';
...
import { TamaraAdapter } from './tamara/tamara.adapter';
import { TabbyAdapter } from './tabby/tabby.adapter';
import { TamtamAdapter } from './tamtam/tamtam.adapter';
import { TakealotAdapter } from './takealot/takealot.adapter';
import { TataCliqAdapter } from './tata-cliq/tata-cliq.adapter';
...
import { ToriAdapter } from './tori/tori.adapter';
...
import { TraderaAdapter } from './tradera/tradera.adapter';
import { TradesyAdapter } from './tradesy/tradesy.adapter';
import { TuttiChAdapter } from './tutti-ch/tutti-ch.adapter';
import { TweakersAdapter } from './tweakers/tweakers.adapter';
import { TweeDehandsAdapter } from './twee-dehands/twee-dehands.adapter';
...
import { TokopediaFlashAdapter } from './tokopedia-flash/tokopedia-flash.adapter';
...
import { UdaanAdapter } from './udaan/udaan.adapter';
...
import { ToyzzShopAdapter } from './toyzz-shop/toyzz-shop.adapter';
import { VirginMegastoreAdapter } from './virgin-megastore/virgin-megastore.adapter';
...
import { WillhabenAdapter } from './willhaben/willhaben.adapter';
...
import { ZoodAdapter } from './zood/zood.adapter';
...
export class AdapterRegistry {
  ...
  constructor(
    ...
    private readonly sbermarket: SbermarketAdapter,
    ...
    private readonly olxPl: OlxPlAdapter,
    ...
    private readonly udaan: UdaanAdapter,
    ...
    private readonly shohoz: ShohozAdapter,
    ...
    private readonly chaldal: ChaldalAdapter,
    ...
    private readonly craftsvilla: CraftsvillaAdapter,
    ...
    private readonly limundo: LimundoAdapter,
    ...
    private readonly aliexpressRu: AliexpressRuAdapter,
    private readonly autods: AutodsAdapter,
    private readonly autotrader: AutotraderAdapter,
    private readonly avito: AvitoAdapter,
    ...
    private readonly kupujemProdajem: KupujemProdajemAdapter,
    ...
    private readonly khaadi: KhaadiAdapter,
    ...
    private readonly tataCliq: TataCliqAdapter,
    ...
    private readonly pepperfry: PepperfryAdapter,
    ...
    private readonly nykaa: NykaaAdapter,
    ...
    private readonly pazaruvaj: PazaruvajAdapter,
    private readonly realde: RealdeAdapter,
    private readonly reverb: ReverbAdapter,
    private readonly relianceDigital: RelianceDigitalAdapter,
    ...
    private readonly razorpayStore: RazorpayStoreAdapter,
    ...
    private readonly favi: FaviAdapter,
    private readonly gotoBusiness: GotoBusinessAdapter,
    private readonly gotoLk: GotoLkAdapter,
    ...
    private readonly limeroad: LimeroadAdapter,
    ...
    private readonly dba: DbaAdapter,
    private readonly deuxiemeMain: DeuxiemeMainAdapter,
    private readonly finnNo: FinnNoAdapter,
    private readonly fyndiq: FyndiqAdapter,
    private readonly olxPt: OlxPtAdapter,
    private readonly pricespy: PricespyAdapter,
    private readonly ricardoCh: RicardoChAdapter,
    private readonly tori: ToriAdapter,
    private readonly tradera: TraderaAdapter,
    private readonly tuttiCh: TuttiChAdapter,
    private readonly tweakers: TweakersAdapter,
    private readonly tweeDehands: TweeDehandsAdapter,
    private readonly willhaben: WillhabenAdapter,
    private readonly arbuzKz: ArbuzKzAdapter,
    private readonly auchan: AuchanAdapter,
    private readonly cashi: CashiAdapter,
    private readonly jumiaEt: JumiaEtAdapter,
    private readonly jumiaGh: JumiaGhAdapter,
    private readonly jumiaTn: JumiaTnAdapter,
    private readonly leroyMerlin: LeroyMerlinAdapter,
    private readonly luluOnline: LuluOnlineAdapter,
    private readonly marketKz: MarketKzAdapter,
    private readonly megatrade: MegatradeAdapter,
    private readonly tamara: TamaraAdapter,
    private readonly tabby: TabbyAdapter,
    private readonly tamtam: TamtamAdapter,
    private readonly zood: ZoodAdapter,
    private readonly avansas: AvansasAdapter,
    private readonly bebekCom: BebekComAdapter,
    private readonly carrefourSa: CarrefourSaAdapter,
    private readonly gofood: GofoodAdapter,
    private readonly grabmart: GrabmartAdapter,
    private readonly kukla: KuklaAdapter,
    private readonly pandamart: PandamartAdapter,
    private readonly tokopediaFlash: TokopediaFlashAdapter,
    private readonly toyzzShop: ToyzzShopAdapter,
    private readonly virginMegastore: VirginMegastoreAdapter,
    ...
    this.adapters = new Map<string, IMarketplaceAdapter>([
      ...
      ['HEUREKA', heureka],
      ['KOMPLETT', komplett],
      ['KUPUJEM_PRODAJEM', kupujemProdajem],
      ['MUMZWORLD', mumzworld],
      ['OLX', olx],
      ['OLX_PL', olxPl],
      ['POWER_DK', powerDk],
      ...
      ['NYKAA', nykaa],
      ['PEPPERFRY', pepperfry],
      ['RAZORPAY_STORE', razorpayStore],
      ['RELIANCE_DIGITAL', relianceDigital],
      ['SHOHOZ', shohoz],
      ['TATA_CLIQ', tataCliq],
      ['UDAAN', udaan],
      ['DBA', dba],
      ['DEUXIEME_MAIN', deuxiemeMain],
      ['FINN_NO', finnNo],
      ['FYNDIQ', fyndiq],
      ['OLX_PT', olxPt],
      ['PRICESPY', pricespy],
      ['RICARDO_CH', ricardoCh],
      ['TORI', tori],
      ['TRADERA', tradera],
      ['TUTTI_CH', tuttiCh],
      ['TWEAKERS', tweakers],
      ['TWEE_DEHANDS', tweeDehands],
      ['WILLHABEN', willhaben],
      ['ARBUZ_KZ', arbuzKz],
      ['AUCHAN', auchan],
      ['CASHI', cashi],
      ...
      ['AVANSAS', avansas],
      ['BEBEK_COM', bebekCom],
      ['CARREFOUR_SA', carrefourSa],
      ['GOFOOD', gofood],
      ['GRABMART', grabmart],
      ['KUKLA', kukla],
      ['PANDAMART', pandamart],
      ['TOKOPEDIA_FLASH', tokopediaFlash],
      ['TOYZZ_SHOP', toyzzShop],
      ['VIRGIN_MEGASTORE', virginMegastore],
    ]);
