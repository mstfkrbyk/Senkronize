...
export const MARKETPLACE_LABEL_TR: Partial<Record<Marketplace, string>> = {
  ...
  [Marketplace.NYKAA]: 'Nykaa',
  [Marketplace.TATA_CLIQ]: 'Tata Cliq',
  [Marketplace.RELIANCE_DIGITAL]: 'Reliance Digital',
  [Marketplace.PEPPERFRY]: 'Pepperfry',
  [Marketplace.LIMEROAD]: 'Limeroad',
  [Marketplace.CRAFTSVILLA]: 'Craftsvilla',
  [Marketplace.UDAAN]: 'Udaan',
  [Marketplace.DARAZ_PK]: 'Daraz PK',
  [Marketplace.GOTO_LK]: 'Goto.lk',
  [Marketplace.KHAADI]: 'Khaadi',
  [Marketplace.CHALDAL]: 'Chaldal',
  [Marketplace.SHOHOZ]: 'Shohoz',
  [Marketplace.JUSPAY]: 'Juspay',
  [Marketplace.RAZORPAY_STORE]: 'Razorpay Store',
  [Marketplace.FAVI]: 'Favi',
  [Marketplace.LIMUNDO]: 'Limundo',
  [Marketplace.KUPUJEM_PRODAJEM]: 'KupujemProdajem',
  [Marketplace.NJUSKALO]: 'Njuškalo',
  [Marketplace.OLX_PL]: 'OLX Polonya',
  [Marketplace.ALIEXPRESS_RU]: 'AliExpress RU',
  [Marketplace.AVITO]: 'Avito',
  [Marketplace.SBERMARKET]: 'Sbermarket',
  [Marketplace.PAZARUVAJ]: 'Pazaruvaj',
};
