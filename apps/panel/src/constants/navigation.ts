...
export const NAV_ITEMS: NavItem[] = [
  ...
  { labelKey: 'nav.stockWarehouses', icon: Warehouse, path: '/stock/warehouses' },
  { labelKey: 'nav.stockMovements', icon: History, path: '/stock/movements' },
  { labelKey: 'nav.stockDistribution', icon: PieChart, path: '/stock/distribution' },
  { labelKey: 'nav.stockForecast', icon: LineChart, path: '/stock/forecast' },
  { labelKey: 'nav.stockCount', icon: ScanLine, path: '/stock/count' },
  { labelKey: 'nav.stockCountScan', icon: ScanLine, path: '/stock/count/scan' },
