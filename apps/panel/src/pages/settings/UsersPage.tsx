...
export function UsersPage(): ReactElement {
  ...
  const resendInviteMutation = useMutation({
    mutationFn: async (id: string): Promise<void> => {
      await api.post(`/users/invites/${id}/resend`);
    },
    onSuccess: () => {
      invalidateUsers();
  ...
  return (
    <div className="space-y-10">
      ...
      <div>
        <h3 className="text-lg font-medium text-primary">Aktif oturumlar</h3>
        <p className="mb-4 text-sm text-muted-foreground">
          Bu cihaz dışındaki oturumları güvenlik için sonlandırabilirsiniz.
        </p>
        ...
        <DialogContent>
          ...
          <Form {...inviteForm}>
            ...
            >
              ...
              />
              <p className="text-sm text-muted-foreground">
                Davet e-postası, hesabı oluşturup organizasyona katılmak için güvenli bağlantı
                içerir.
              </p>
              <DialogFooter>
      ...
      <Dialog open={transferOpen} onOpenChange={setTransferOpen}>
        <DialogContent>
          ...
          <p className="text-sm text-muted-foreground">
            Yeni sahip olarak seçilen kullanıcı <strong>Yönetici</strong> rolüne indirgenen mevcut
            sahip ile yer değiştirir.
          </p>
      ...
      <AlertDialog open={removeId != null} onOpenChange={() => setRemoveId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bu kullanıcı organizasyondan çıkarılacak ve oturumları sonlandırılacak. Devam etmek
              istiyor musunuz?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
