...
export function PlatformDistributionWidget(): ReactElement {
  const query = useQuery({
    queryKey: ['dashboard', 'platform-distribution'],
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        ...
        <CardDescription>Son 30 gün sipariş payı</CardDescription>
      </CardHeader>
