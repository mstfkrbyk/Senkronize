...
> = {
  ...
  MADE_COM: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  ARTICLE: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  JOSS_MAIN: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  BIRCH_LANE: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  PERIGOLD: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  KARACA: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  MADAME_COCO: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  ENGLISH_HOME: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  LINENS_N_THINGS: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  GARDENA: [
    { key: 'clientId', label: 'OAuth2 Client ID', type: 'text', required: true },
    {
      key: 'clientSecret',
  ...
  OBI_TR: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  BAUHAUS_TR: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  ...
  JUMIA_GH: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  JUMIA_TN: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  CARREFOUR_SA: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  LULU_ONLINE: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  VIRGIN_MEGASTORE: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  PANDAMART: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  AVANSAS: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  KUKLA: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  BEBEK_COM: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  TOYZZ_SHOP: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  ...
  ALIBABA_B2B: [
    { key: 'apiKey', label: 'API Key', type: 'text', required: true },
    { key: 'apiSecret', label: 'API Secret (HMAC)', type: 'password', required: true },
  ],
  GLOBAL_SOURCES: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  DHGATE: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  INDIAMART: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  TRADEINDIA: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  EC21: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  TEDARIKCI: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  BUYUK_MAGAZA: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  TOPTANEVI: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  SAHIBINDEN_B2B: [
    { key: 'apiKey', label: 'API Key', type: 'text', required: true },
    { key: 'apiSecret', label: 'API Secret', type: 'password', required: true },
  ],
  ...
  OBERLO: [{ key: 'apiKey', label: 'API Key (legacy)', type: 'password', required: true }],
  AUTODS: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
  DOBA: [{ key: 'apiKey', label: 'API Key', type: 'password', required: true }],
