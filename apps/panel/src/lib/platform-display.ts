...
export const MARKETPLACE_DISPLAY: Record<string, PlatformDisplayMeta> = {
  ...
  GRABMART: { label: 'Grab Mart (API)', logo: '🛒', color: 'emerald' },
  GOFOOD: { label: 'Gofood Merchant', logo: '🍔', color: 'green' },
  TOKOPEDIA_FLASH: { label: 'Tokopedia Flash', logo: '⚡', color: 'lime' },
  JUMIA_GH: { label: 'Jumia Gana', logo: '🇬🇭', color: 'orange' },
  JUMIA_TN: { label: 'Jumia Tunus', logo: '🇹🇳', color: 'orange' },
  CARREFOUR_SA: { label: 'Carrefour KSA', logo: '🛒', color: 'blue' },
  LULU_ONLINE: { label: 'LuLu Online', logo: '🛍️', color: 'red' },
  VIRGIN_MEGASTORE: { label: 'Virgin Megastore', logo: '🎵', color: 'red' },
  PANDAMART: { label: 'Pandamart', logo: '🐼', color: 'rose' },
  AVANSAS: { label: 'Avansas', logo: '📎', color: 'slate' },
  KUKLA: { label: 'Kukla', logo: '🧸', color: 'pink' },
  BEBEK_COM: { label: 'Bebek.com', logo: '👶', color: 'sky' },
  TOYZZ_SHOP: { label: 'Toyzz Shop', logo: '🎮', color: 'violet' },
